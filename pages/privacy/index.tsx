        ...
        <main className={styles.termsPage}>
          <div style={{ paddingLeft: 20, paddingRight: 50 }}>
            ...
            <ol className={styles.orderedList}>
              ...
              <p>
                O Instituto Reditus (“Reditus”) é uma associação privada, sem
                fins lucrativos, formada principalmente por alunos e ex-alunos
                da Universidade Federal do Rio de Janeiro (“UFRJ”).
              </p>
              <p>
                Nosso objetivo é fortalecer a comunidade de alunos e ex alunos
                da UFRJ que desejam se vincular ao Instituto Reditus, fomentando
                a cultura de retribuição e aprimorando a experiência
                educacional, por meio da realização de coletas de doações e
                desenvolvimento de projetos de apoio financeiro, material e
                social aos corpo discente, separadamente ou em conjunto com
                entidades parceiras. O Reditus é uma iniciativa privada de
                ex-alunos e simpatizantes da UFRJ e não possui qualquer vinculo
                com a Universidade.
              </p>
              ...
              <p>
                ...
                parceiros, doadores] e alunos que participarem de seus editais
                ou programas e se aplica às pessoas que diretamente interajam
                como o Reditus na qualidade de membros, doadores, parceiros ou
                como participantes de seus programas, bem como às pessoas
                vinculadas às entidades que interajam com o Instituto Reditus.
              </p>
              <p>
                Por meio desse documento, o Reditus informa sobre o tratamento
                que dá a dados pessoais, a fim de esclarecer quais informações
                são coletadas, utilizadas, armazenadas, descartadas ou
              ...
              <ul>
                <li>
                  <b>&quot;Membros&quot;</b>: pessoa natural que integra o
                  quadro de associados do Instituto Reditus, que contribui
                  financeiramente ao Instituto ou que participada de seus
                  projetos como mentor ou tutor.
                </li>
                <li>
                ...
                <li>
                  <b>&quot;Titular&quot;</b>: pessoa natural a quem se referem
                ...
                <li>
                  ...
                  transferência, difusão ou extração de dados de pessoas
                  físicas;
                </li>
                <li>
                ...
                <li>
                  <b>&quot;Necessidade&quot;</b>: a indispensabilidade de um
                  dado pessoal no atingimento da finalidade pretendida. Na
                  medida das capacidades do Reditus, os dados pessoais sujeitos
                  a tratamento serão limitados ao mínimo necessário para que se
                  alcance tal finalidade, ou seja, o conjunto de dados tratados
                  deve ser pertinente, proporcional e não excessivo;
                </li>
                <li>
                  <b>&quot;Consentimento&quot;</b>:autorização livre, informada
                  e inequívoca (sem deixar dúvidas) pela qual o Titular concorda
                  com o tratamento de seus dados pessoais para uma finalidade
                  previamente estipulada. Após conceder o consentimento, o
                  Titular poderá revogá-lo a qualquer tempo para tratamentos
                  futuros, sendo mantido, porém, o tratamento realizado até
                  aquele momento.
                </li>
              </ul>
              <br />
              ...
              <p>
                Esta Política se aplica às pessoas que diretamente interajam
                como o Reditus na qualidade de membros, doadores, parceiros ou
                como participantes de seus programas, bem como às pessoas
                vinculadas às entidades que interajam com o Instituto Reditus.
              </p>
              ...
              <br />
              <li className={styles.listItem}>
                Finalidade do tratamento de dados pessoais pelo Instituto
                Reditus
              </li>
              <br />
              <table className={styles.table}>
                ...
                <tr className={styles.table}>
                  <td className={styles.table}>
                    A fim de enviar informações administrativas sobre o
                    Instituto.
                  </td>
                  <td className={styles.table}>
                    Art. 7º, V da LGPD - execução do contrato.
                ...
                <tr className={styles.table}>
                  <td className={styles.table}>
                    Para fins de aprimoramento do Instituto, como
                    desenvolvimento de novos projetos e melhoria do site.
                  </td>
                  <td className={styles.table}>
                ...
                <tr className={styles.table}>
                  <td className={styles.table}>
                    ...
                    permitir o alcance de recursos disponíveis ou limitar os
                    danos causados ao Instituto Reditus.
                  </td>
                  <td className={styles.table}>
                    Art. 7º, IX da LGPD - interesse legítimo.
                  </td>
                ...
                <tr className={styles.table}>
                  <td className={styles.table}>
                    ...
                    serviços (por exemplo, comunicações de marketing ou
                    campanhas ou promoções). Isso poderá ser feito por meios
                    como e-mail, anúncios, SMS, ligações telefônicas e
                    correspondências postais na medida em que permitidas pela
                    lei aplicável.
                  </td>
                  <td className={styles.table}>
              ...
              <p>
                ...
                conexões pode permitir que terceiros coletem ou compartilhem
                seus dados. O Instituto Reditus não é responsável pela Política
                de Privacidade destes sites de terceiros, portanto, quando sair
                desta plataforma, você deve ler a Política de Privacidade
                específica de cada sítio eletrônico visitado antes de consentir
                com o tratamento de seus dados por tal terceiro.
              </p>
              <p>
                ...
                estrangeiros, o Reditus garante que tais países possuem
                legislação de proteção de dados equivalente à LGPD, ou, caso
                contrário, celebrou contrato contendo as salvaguardas legalmente
                exigidas.
              </p>
              <li className={styles.listItem}>
              ...
              <ul>
                <li>
                  ...
                  dúvida, os titulares de dados pessoais podem entrar em contato
                  a fim de confirmar se algum dado pessoal é tratado ou
                  armazenado pelo Reditus. Os requerimentos serão respondidos:
                  <ul>
                ...
                <li>
                  <b>Acesso aos dados:</b> é direito dos titulares requerer
                  acesso aos dados existentes e tratados pelo Reditus. Caso o
                  tratamento seja baseado em contrato ou em consentimento, o
                  titular poderá requerer cópia integral de seus dados pessoais.
                  Os requerimentos serão respondidos:
                  <ul>
                    <li>em formato simplificado, imediatamente; </li>
                    <li>
                      por meio de declaração clara e completa, que indique a
                ...
                <li>
                  ...
                  importante que os dados pessoais sejam precisos e atuais,
                  assim, cabe ao titular manter o Instituto Reditus informado
                  nos casos em que seus dados pessoais precisem ser corrigidos.
                </li>
                <li>
                  <b>
                  ...
                  dados pessoais. Tal solicitação só será negada pelo Reditus
                  nos casos em que o pedido não possa ser atendido ou nos casos
                  em que for obrigatório ou permitido seu armazenamento, nas
                  hipóteses elencadas no art. 7º da LGPD e demais dispositivos
                  aplicáveis. Dados anonimizados são aqueles que não
                  possibilitam a identificação do titular, considerando a
                  utilização de meios técnicos, razoáveis e disponíveis na
                  ocasião do tratamento. Em razão de a anonimização impedir a
                  identificação do indivíduo, os dados anonimizados deixam de
                  ser considerados pessoais e, portanto, passam a estar fora do
                  escopo de aplicação da LGPD, desde que o processo de
                  anonimização não possa ser revertido, considerando-se os
                  critérios legalmente aplicáveis.
                </li>
                <li>
                  <b>
                ...
                <li>
                  ...
                  forem encaminhados às entidades públicas e privadas, exceto,
                  em situações não permitidas previstas em lei.
                </li>
                <li>
                  <b>
                  ...
                  o Instituto Reditus está disponível para atender e auxiliar,
                  de forma transparente, quaisquer dúvidas que possam existir em
                  função do tratamento dos dados pessoais dos titulares.
                  Inclusive informar quais são os possíveis impactos negativos
                  caso o titular dos dados revogue o seu consentimento para o
                  uso dos dados pessoais, nos casos em que a base legal para
                ...
                <li>
                  ...
                  qualquer momento por meio de pedido formal ao Instituto
                  Reditus.
                </li>
              </ul>
              <br />
              ...
              <p>
                ...
                Política de Privacidade a qualquer tempo. Em caso de alteração,
                o titular será informado por e-mail e pela interface da
                plataforma antes da entrada em vigor da alteração. Caso não
                concorde com as alterações, poderá revogar seu consentimento na
                forma da lei.
              </p>
              <li className={styles.listItem}>Legislação e Foro:</li>
              <p>
                Esta Política de Privacidade será regida, interpretada e
                aplicada de acordo com as Leis da República Federativa do
                Brasil, independentemente das Leis de outros estados ou Países,
                sendo competente o foro da Comarca da Capital do Estado do Rio
                de Janeiro para dirimir qualquer dúvida decorrente deste
                documento.
              </p>
              ...
              <p>
                Instituto Fundo Patrimonial Reditus, inscrito no CNPJ/MF sob o
                no. 34.989.305/0001-90, com sede na Cidade do Rio de Janeiro,
                Estado do Rio de Janeiro, na Rua Visconde de Pirajá, numero 500,
                sala 115, Ipanema, CEP 22410-901.
              </p>
              <p>
