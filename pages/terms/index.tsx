          ...
          <div style={{ paddingLeft: 20, paddingRight: 50 }}>
            ...
            <ol className={styles.orderedList}>
              ...
              <p>
                ...
                ao Instituto ou para contribuir através de doações ou de
                qualquer outra forma, é necessária a concordância com os termos
                e condições aqui descritos.
              </p>
              ...
              <ul>
                <li>
                  <b>&quot;Instituto Reditus&quot;</b>: associação civil
                  inscrita no Cadastro Nacional da Pessoa Jurídica (CNPJ) sob o
                  no 34.989.305/0001-90;
                </li>
                <li>
                  <b>&quot;Usuário&quot;</b>: pessoa natural que integra o
                  quadro de associados do Instituto Reditus, que contribui
                  financeiramente ao Instituto ou que participa de seus
                  projetos;
                </li>
                <li>
                ...
                <li>
                  <b>&quot;Política de Privacidade&quot;</b>: documento pelo
                  qual o Instituto Reditus esclarece em detalhes, o tratamento
                  de dados pessoais dos Membros, em atendimento à legislação
                  vigente, sobretudo, de acordo com as disposições da Lei Geral
                  de Proteção de Dados (Lei 13.709/18);
                </li>
                <li>
                ...
                <li>
                  ...
                  os dados pessoais objeto do tratamento de dados pessoais;
                </li>
                <li>
                ...
                <li>
                  ...
                  e inequívoca (sem deixar dúvidas) pela qual o Usuário concorda
              ...
              <p>
                Será considerado Usuário, a pessoa natural que integra o quadro
                de associados do Instituto Reditus, que contribui
                financeiramente ao Instituto ou que participa de seus projetos.
              </p>
              <p>
                Para isso deverá informar: (i) seu nome e sobrenome; (ii) e-mail
                e (iii) CPF (iv) CEP; (v) telefone; (vi) dados bancários; (vii)
                data de nascimento; (viii) facebook, linkedin ou Skype; (ix)
                endereço; (x) dados profissionais; e (xi) dados de formação.
              </p>
              <p>
              ...
              <p>
                O Usuário garante e responde, em qualquer caso, pela veracidade
                e exatidão dos dados informados, devendo fornecer informações
                verdadeiras, exatas, atuais e completas para que serviço
                prestado cumpra a finalidade dele esperada.
              </p>
              <p>
              ...
              <ul>
                <li>
                  ...
                  responsável legal, além de ser plenamente capaz para se
                  vincular a estes Termos e Condições de Uso e aceitar e cumprir
              ...
              <p>
                Ainda, o Instituto Reditus não se responsabiliza nos casos em
                que as empresas operadoras dos meios de pagamento vierem a
                admitir o uso de cartões por quem não for seu legítimo titular,
                sendo tais empresas as únicas responsáveis por eventuais
                fraudes.
              </p>
              <p>
              ...
              <p>
                O site entra em vigor por prazo indeterminado, podendo o
                Instituto Reditus suspendê-lo ou encerrá-lo a qualquer tempo, e
              ...
              <p>
                ...
                disponível em www.reditus.org.br - conforme as disposições da
                Lei Geral de Proteção de Dados (Lei 13.709/18) - e declara
                expressamente que aceita e concorda com as previsões nela
                descritas.
              </p>
              <li className={styles.listItem}>
                Alteração dos Termos e Condições de Uso e Política de
                Privacidade
              </li>
              <p>
                O Instituto Reditus poderá modificar, a qualquer tempo, os
                Termos e Condições de Uso e Política de Privacidade da
                Plataforma, visando seu aprimoramento e correspondência com os
                serviços prestados ou para atender questões legais,
                administrativas ou ordens judiciais. É de exclusiva
                responsabilidade do Usuário a verificação de tais documentos
                periodicamente.
              </p>
              <p>
                O Instituto Reditus pode, por mera liberalidade, informar ao
                Usuário acerca de alterações significativas através de avisos
                por e-mail, mensagens na plataforma, banners no website ou
                aplicativo, ou meio outro que considerar adequado.
              </p>
              <p>
              ...
              <p>
                O uso comercial da expressão “Instituto Reditus” como marca,
                nome empresarial ou nome de domínio, bem como os conteúdos das
                telas relativas à plataforma, programas, bancos de dados, redes
                e arquivos, são propriedade do Instituto Reditus e estão
                protegidos pelas leis brasileiras e tratados internacionais de
                direito autoral, marcas, patentes, modelos e desenhos
                industriais. O uso indevido e a reprodução total ou parcial dos
                referidos conteúdos são proibidos, salvo a autorização expressa
                do Instituto Reditus.
              </p>
              <p>
                O Instituto Reditus possui todos os direitos intelectuais pelos
                conteúdos contidos no website, incluindo, sem limitação, todos
                os direitos do software, de títulos, patentes, marcas, logos,
                modelos de serviço, nomes comerciais, design, código fonte,
                banco de dados, textos, conteúdos, gráficos, ícones e
                hyperlinks. Ao concordar com estes Termos e Condições de Uso, o
                Usuário estará concordando em não reproduzir ou distribuir
                quaisquer conteúdos do site e da plataforma, sem a obtenção e
                consentimento do Instituto Reditus.{" "}
              </p>
              <li className={styles.listItem}>
              ...
              <p>
                ...
                qualquer tipo de atividade ilegal ou para tomar qualquer ação
                que afete negativamente os desempenhos do sistema, bem como que
                não se envolverá, nem ajudará - por intenção ou omissão - um
                terceiro com o propósito de:{" "}
              </p>
              <ul>
                <li>
                ...
                <li>
                  violar qualquer lei, estatuto, ordenança ou regulamento;
                </li>
                <li>
              ...
              <p>
                Qualquer controvérsia decorrente da interpretação ou aplicação
                do presente Contrato será resolvida de acordo com o princípio da
                boa-fé, elegendo as partes foro da cidade do Rio de Janeiro,
                Estado do Rio de Janeiro, como competente para processar e
                julgar quaisquer disputas oriundas desta relação.
              </p>
